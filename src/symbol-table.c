...
{
  LABEL *result = symtab_add_label(task_name, /*addr_set*/ true, task_addr, /*is_task*/ true);
  return result;
}
...
{
  LABEL *result = symtab_add_label(task_name, /*addr_set*/ false, /*addr*/ 0, /*is_task*/ true);
  return result;
}
...
{
  LABEL *result = symtab_add_label(label_name, /*addr_set*/ true, jump_addr, /*is_task*/ false);
  return result;
}
